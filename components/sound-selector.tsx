...
export const SOUND_OPTIONS = [
  ...
  { id: "mechanical", name: "Mechanical", file: "/sounds/mechanical.mp3" },
  { id: "soft", name: "Soft Keys", file: "/sounds/soft.mp3" },
  { id: "vintage", name: "Vintage", file: "/sounds/vintage.mp3" },
  { id: "modern", name: "Modern", file: "/sounds/modern.mp3" },
